...
const header = () => {
    ...
    const [isOpenCatelog, setIsOpenCatelog] = useState(false);
    const [isOpenIndividuals, setIsOpenIndividuals] = useState(false);
    ...
    return <>
                ...
                >
                    <nav className="nav_container">
                        ...
                        <div className="nav-right_wrapper">
                            ...
                            >
                                <div
                                    className={`nav_profile_toggle w-dropdown-toggle ${isDropdownOpen ? "w-open" :""}`}
                                    ...
                                    >
                                        {isLoggedIn ? (
                                            <div
                                                ...
                                                className={`0nav_profile_wrap ${isDropdownOpen ?"w-open":""}`}
                                                style={{ display: "block" }}
                                            >
                                                <a
                                            ...
                                            <div
                                                cb-element="logged-out"
                                                className={`nav_profile_wrap not-loggedin ${isDropdownOpen?"w--open":""}`}
                                                style={{ display: "flex" }}
                                            >
                                ...
                                <div nav-style="outline" className="nav_links-wrapper">
                                    ...
                                    >
                                        <div
                                            ...
                                            aria-controls="w-dropdown-list-0"
                                            aria-haspopup="menu"
                                            aria-expanded={isOpenCatelog}
                                            role="button"
                                            tabIndex={0}
                                            onClick={() => setIsOpenCatelog((prev) => !prev)}
                                        >
                                            <div className="nav_link-alt">Catalog</div>
                                            <img
                                                loading="lazy"
                                    ...
                                    >
                                        <div
                                            ...
                                            role="button"
                                            tabIndex={0}
                                            onClick={() => setIsOpenIndividuals((prev) => !prev)}
                                        >
                                            <div className="nav_link-alt">For Individuals</div>
                                            <img
                                                src="https://cdn.prod.website-files.com/63eef15e3ff8fd318e9a6888/645b477d89482a992ae754da_down-chevron.svg"
                                    ...
                                    >
                                        <div
                                            ...
                                            role="button"
                                            tabIndex={0}
                                            onClick={() => setIsOpenBusiness((prev) => !prev)}
                                        >
                                            <div className="nav_link-alt">For Business</div>
                                            <img
                                                src="https://cdn.prod.website-files.com/63eef15e3ff8fd318e9a6888/645b477d89482a992ae754da_down-chevron.svg"
        ...
        {isOpenSignIn &&
            <div className="padding-global" style={{
                ...
                <div className="container-large" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal_component">
                            <div className="modal_content">
                                ...
                                <div className="modal_sso-wrap">
                                    <a onClick={() => setIsOpenSignIn(true)} className="text-color-silver">
                                        or sign up with
                                    </a>
                        ...
                        <div className="modal_component">
                            <div className="modal_content">
                                <img
                                    ...
                                    className="modal_logo"
                                />
                                <div className="heading-style-h2">Sign Up</div>
                                <div className="modal_join-text">
                                    Join over <span className="text-color-white">3 million</span>{" "}
                                    cybersecurity professionals advancing their career
                                </div>
